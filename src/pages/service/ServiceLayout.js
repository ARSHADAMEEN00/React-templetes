...
import { client1 } from "assets/img";
import { client2 } from "assets/img";
import { client3 } from "assets/img";
import { client4 } from "assets/img";
import { trophy } from "assets/img";
import { services1 } from "assets/img";
import { services3 } from "assets/img";
import { services2 } from "assets/img";
import { services4 } from "assets/img";
      ...
      <section id="hero" className="hero d-flex align-items-center custom_hero">
        <div className="container custom_container">
          <div className="row custom_row">
            <div className="col-lg-6 custom_child_div1 d-flex flex-column justify-content-center">
              <h1 data-aos="fade-up">
                {title}
                <br /> Development
              </h1>
            ...
            <div
              className="col-lg-6 hero-img custom_child_div2"
              data-aos="zoom-out"
              data-aos-delay="200"
            >
              {heroSvg}
